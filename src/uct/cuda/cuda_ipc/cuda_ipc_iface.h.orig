...
typedef struct uct_cuda_ipc_iface {
    ...
    ucs_queue_head_t outstanding_h2d_event_q;
    ucs_queue_head_t outstanding_d2h_event_q;
    int              device_count;
    int              streams_initialized;
    CUstream         stream_d2d[UCT_CUDA_IPC_MAX_PEERS];
    CUstream         stream_d2h[UCT_CUDA_IPC_MAX_PEERS];
    CUstream         stream_h2d[UCT_CUDA_IPC_MAX_PEERS];
